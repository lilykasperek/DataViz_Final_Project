...
kable(owner_rank2, caption = "Who Makes the Most Donations Across All Leagues?",
      col.names = c("Owner", "Team", "League", "Amount of Donations Made")) %>%
  kable_classic()
```
...
ggplot(data = frequent, aes(x = amount, y = Owner, label = Amount, colour = Party)) +
  geom_point() +
  labs(title = "How Much Do They Donate?",
       y = "Owners",
       x = "Amount Donated",
       colour = "Party") +
